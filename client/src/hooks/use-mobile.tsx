...
import logo from "../assets/NEXFOUNDERS WHITE LOGO.svg"; // Adjust path as necessary
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-nexdark shadow-lg backdrop-blur-md'
          : 'bg-nexdark/90 backdrop-blur-md'
      ...
      <div className="max-w-10xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {/* On desktop: hide Founders, Investors & Talents */}
            {!isMobile && (
              <>
                {/* You could omit these links here */}
              </>
            )}
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-nexdark border-t border-gray-800 py-4">
            <div className="flex flex-col space-y-4 px-4">
              {/* On mobile: show Founders, Investors & Talents */}
              <a
                href="#founders"
